...
### 4.4 2026-09-16 決定 — もう1週据え置き

Live 9開催（8/15・8/16・8/22・8/23・8/29・8/30・9/5・9/6・9/12、312R）:

| 指標 | 値 | 読み |
|------|-----|------|
| ticketPrecision | **1.86%**（37/1986） | 2週目標 ≥1% は達。1ヶ月 ≥2% まで −0.14pp |
| 密度 | **6.4** | 目標帯 5–15 内。閾値を動かさない |
| 仮想RR | 97.8% | 8/29 外れ値を含む。新目標にしない |
| 複勝 | **0/42** | 次の1変更候補のまま。今週はやらない |
| 枠連 | 13/365（3.56%） | 本体の厚い券種 |

9/13 は朝凍結が無く、残オッズは土曜 07:07 JST。後追い freeze はしない（欠測のまま）。

**採用（2026-09-16）:**

| # | やること | 状態 |
|---|----------|------|
| 1 | **設定据え置き**（25 / 80上限 / 65）。9/19・9/20・9/21 を同じゲートで回す | **決定。次開催で実行** |
| 2 | 各日 **最初の発走前に `loop:freeze`**（目安 9:00 JST） | 運用 |
| 3 | 3日後に 12開催合算で 2% を再判定。届かなければ次の1変更は **複勝既定 OFF** | 9/21 夜以降 |

**やらない:** scoreMin を動かす / 複勝を今週切る / 9/13 を土曜オッズで埋める / 本体と研究所の KPI を合算する / 8/29 の 5.52% を新目標にする / 8/30 の 0.78% を新下限にする

検証メモ: [VERIFY-2026-09-12.md](./VERIFY-2026-09-12.md) · [verify/analyze-2026-09-12.json](./verify/analyze-2026-09-12.json)
...
| 閾値の当面案 | **25 / 80上限 / 65**（2026-08-13）。**9/19–21 も据え置き**（2026-09-16）。70 は注目穴消滅＋過厳選で不採用 |
| 次の1変更 | 9/21 後の再判定まで保留。候補は **複勝既定 OFF**（9開催 0/42） |
...
| [VERIFY-2026-09-12.md](./VERIFY-2026-09-12.md) / [verify/analyze-2026-09-12.json](./verify/analyze-2026-09-12.json) | scoreMin65 の9開催合算と 9/19–21 据え置き決定 |
