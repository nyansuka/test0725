        ...
        <div className="bg-sand px-4 py-8 sm:px-6 md:px-8 md:py-16">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-3 max-w-2xl text-ink/70">
              スコア実装は差し替え可能です。人気乖離・近況は導出済み。コース形態はレース詳細に参考として出し、検証済みの距離だけ枠バイアスへ小さく載せるだけです。新潟芝は形状の注記のみ。新潟ダ1200の芝スタートは外枠・前残りを枠と危1へ。展開／馬場は当面ルール＋仮値。調教・馬体重は読み方の補足のみで、スコアには含めません。場や馬を瞬発戦／持続力戦に分けるラベルは使いません。
            </p>
          </div>
        </div>
        <Method />
