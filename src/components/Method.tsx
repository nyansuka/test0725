const steps = [
  {
    title: "オッズゲート",
    body: "各券種でオッズが設定閾値未満の買い目は原則除外。初期閾値は20倍で変更可能です。",
  },
  {
    title: "複勝圏スコア",
    body: "コース適性・展開・馬場・近況・人気乖離などから placePotential を算出。差し替え可能なルール実装です。",
  },
  {
    title: "候補の提示",
    body: "関係馬のスコア合成と閾値を満たした買い目だけを注目穴ボードに並べます。的中保証はありません。",
  },
];
    ...
    <section id="method" className="bg-turf-deep px-6 py-20 text-sand md:px-8 md:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-3 max-w-xl text-sand/75">
          本命探しではなく高配当候補の選別が主機能です。JRAのみ・全券種対応。デモ／検証用途に限定してください。
        </p>
