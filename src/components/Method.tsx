...
const steps = [
  ...
  {
    title: "危険1人気",
    body: "1番人気を無条件では消しません。人気を除いた1着適性がレース中央値未満、または先行有利コース（新潟芝、および検証済み距離）で差し・追込のときに「危1」印を付けます。軸候補からは外さず、高配当狙いの相手カット用です。",
  },
  {
    title: "短評（評価＋傾向）",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 border-t border-sand/15 pt-8">
          ...
          <p className="mt-1.5 max-w-2xl text-xs leading-relaxed text-sand/70">
            レース詳細に、内回り／外回り・最初のコーナーまでの長さ・前残りか差し余地かを出す。検証済みの距離だけ枠スコアへ小さく寄せる（place でおおむね ±0.4）。京都は未検証。脚質データが薄いので展開適性には載せない。血統・転戦ローテの数字は使わない。
          </p>
        </div>
