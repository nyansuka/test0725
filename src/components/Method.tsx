      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 border-t border-sand/15 pt-8">
          ...
          <p className="mt-1.5 max-w-2xl text-xs leading-relaxed text-sand/70">
            レース詳細に形状だけ出す。見る軸は回り・坂・最初のコーナーまでの長さ・ダートの芝スタート。検証済みの距離だけ枠スコアへ小さく寄せる（place でおおむね ±0.4）。京都は未検証。脚質データが薄いので展開適性には載せない。
          </p>
          <div className="mt-5 grid gap-5 sm:grid-cols-2">
            <div>
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5 text-xs leading-relaxed text-sand/70">
                ...
                <li>芝スタート。外が芝を長く踏める。東京ダ1600・中山ダ1200・阪神ダ1400・中京ダ1400は枠へ小さく。阪神ダ2000・福島ダ1150は弱め。新潟ダ1200は注記のみ。京都ダ1400は未検証。</li>
              </ul>
            </div>
            <div>
